...
define(function(require, exports, module) {
    ...
    iScroll = function (el, options) {
        ...
        that.options = {
            ...
            lockDirection: true,  //false取消拖动方向的锁定， true拖动只能在一个方向上（up/down 或者left/right）为了保持资源的完整性，建议去除滚动条
            useTransform: true,
            useTransition: false,
            topOffset: 0,
            ...
            vScrollbar: true,  //false 隐藏垂直方向上的滚动条
            fixedScrollbar: isAndroid,  //在iOS系统上，当元素拖动超出了scroller的边界时，滚动条会收缩，设置为true可以禁止滚动条超出scroller的可见区域。默认在Android上为true，iOS上为false
            hideScrollbar: isIDevice,  //在没有用户交互时隐藏滚动条 默认为true
            fadeScrollbar: isIDevice && has3d,  //false 指定在无渐隐效果时隐藏滚动条
            scrollbarClass: '',
